...
.addSource("src")
.addSource("src/Component")
.addSource("src/Controller")
.addSource("src/Game")
.addSource("src/MemoryCard")
.addSource("src/MemoryCard/Connector")
...
.then(async function(result)
{
	...
	let createBundle=function(outputFilename,modules)
	{
		...
		let resolvedModules=resolver.resolve(modules,false).filter(module=>!(module in SC.moduleRegister));
...
.then(function()
{
	...
	return require("less").render(`
		@import (once) "System";
		@import (once) "Game";
		@import (once) "Game/Remote";
		@import (once) "Game/Embedded";
		@import (once) "Game/SystemSettings";
		@import (once) "Component/List";
		@import (once) "Component/Course";
	`,{
